...
(
    ...
    CONSTRAINT  ukUser            UNIQUE(email, username)
...
(
    ...
    CONSTRAINT   fkBankUser       FOREIGN KEY(usr_id) REFERENCES users(usr_id)
...
(
    ...
    description  VARCHAR(255)      NULL DEFAULT NULL   COMMENT "Opcional, descripción del ingreso.",
    ...
    CONSTRAINT   fkIngressUser     FOREIGN KEY(usr_id) REFERENCES users(usr_id),
    CONSTRAINT   fkIngressCategory FOREIGN KEY(cat_id) REFERENCES categories(cta_id),
    CONSTRAINT   fkIngressSaving   FOREIGN KEY(sav_id) REFERENCES savings(sav_id),
    CONSTRAINT   fkIngressDebt     FOREIGN KEY(deb_id) REFERENCES debts(deb_id),
    CONSTRAINT   fkIngressAccount  FOREIGN KEY(acc_id) REFERENCES accounts(acc_id)
...
(
    ...
    acc_id       INT               NULL DEFAULT 1      COMMENT "Identificador de la cuenta.",
    concept      VARCHAR(255)      NULL DEFAULT NULL   COMMENT "Opcional, nombre del concepto.",
    description  VARCHAR(255)      NULL DEFAULT NULL   COMMENT "Opcional, descripción del egreso.",
    ...
    CONSTRAINT   fkEgressUser      FOREIGN KEY(usr_id) REFERENCES users(usr_id),
    CONSTRAINT   fkEgressCategory  FOREIGN KEY(cat_id) REFERENCES categories(cta_id),
    CONSTRAINT   fkEgressSaving    FOREIGN KEY(sav_id) REFERENCES savings(sav_id),
    CONSTRAINT   fkEgressDebt      FOREIGN KEY(deb_id) REFERENCES debts(deb_id),
    CONSTRAINT   fkEgressAccount   FOREIGN KEY(acc_id) REFERENCES accounts(acc_id)
) COMMENT "Operaciones de ingresos";
